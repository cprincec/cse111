...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    total_molar_mass = 0
    for unit_list in symbol_quantity_list:
        symbol = unit_list[SYMBOL_INDEX]
        quantity = unit_list[QUANTITY_INDEX]
        name_atomic_mass_list = periodic_table_dict[symbol]
        name = name_atomic_mass_list[NAME_INDEX]
        atomic_mass = name_atomic_mass_list[ATOMIC_MASS_INDEX]
